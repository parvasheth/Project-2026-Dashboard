...
if not df_intra.empty:
    ...
    with vis1:
        ...
        fig_dual.update_layout(
            ...
            yaxis=dict(title="HR", showgrid=True, gridcolor='rgba(128,128,128,0.2)'),
    ...
    with vis2:
        ...
        fig_br.update_layout(
             ...
             yaxis=dict(range=[0,100], title="Body Batt", showgrid=True, gridcolor='rgba(128,128,128,0.2)'),
             yaxis2=dict(overlaying='y', side='right', title="BrPM", showgrid=False),
             margin=dict(t=40, l=10, r=10, b=10),
             legend=dict(orientation="h", y=1.1),
             paper_bgcolor='rgba(0,0,0,0)',
             plot_bgcolor='rgba(0,0,0,0)'
...
with crow2: # Sleep Architecture Timeline
    ...
    if not df_sleep_i.empty:
        ...
        color_map = {"Deep": "#008FFB", "Light": "#00E396", "REM": "#775DD0", "Awake": "#FF4560", "Unknown": "gray"}
        ...
        fig_gantt.update_layout(
            template="plotly_dark", height=300, title="Sleep Hypnogram History",
            paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)',
            margin=dict(t=40,b=10)
        )
...
with p1: # Activity timeline
     if not df_activ.empty:
         ...
         fig_act = px.timeline(
             ...
             height=300, color_discrete_sequence=px.colors.qualitative.Prism 
         )
...
with p2: # Daily Steps Trend
    fig_tr = px.bar(df_daily.tail(30), x='Date', y='Steps', title="30-Day Step Trend")
    fig_tr.update_traces(marker_color='#00E396')
    fig_tr.update_layout(
        template="plotly_dark", height=300, coloraxis_showscale=False,
        paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)'
    )
...
# Weight Check
if not df_intra.empty:
    df_weight = df_intra[df_intra['Type'] == 'BodyComposition']
    pass

with l1:
    fig_vo2 = px.line(df_daily, x='Date', y='VO2Max', markers=True, title="VO2 Max Trend")
    fig_vo2.update_traces(line_color="#775DD0") # Purple
...
with l2:
    if 'HRV_ms' in df_daily.columns:
        ...
        fig_hrv.update_traces(line_color="#008FFB") # Blue
